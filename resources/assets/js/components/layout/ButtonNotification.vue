<template>
    <div>
        <a v-on:click="btn_push()" href="javascript:void(0)" class="btn-theme btn-notification" v-bind:class="!this.isPushEnabled ? 'btn-notification-off' : 'btn-notification-on'">
