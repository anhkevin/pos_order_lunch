                        ...
                        <div class="row">
                            ...
                            <div class="card stacked-2">
                                ...
                                <div class="d-flex align-items-center mb-3 mr-3">
                                    ...
                                    <span class="text-num text-black font-w600"><strong>{{ number_format($user->total_money, 0, ".", ",") . "đ" }}</strong></span> </div>
                                </div>
                                <div class="mr-3 mb-3">
                                    <p class="fs-14 mb-1">Tổng tiền đã nạp</p>
                                    <span class="text-black"><strong>{{ number_format($user->total_deposit, 0, ".", ",") . "đ" }}</strong></span> </div>
                                <div class="mr-3 mb-3">
                                    <p class="fs-14 mb-1">Tổng tiền sử dụng Order</p>
                                    <span class="text-black"><strong>{{ number_format($user->total_paid, 0, ".", ",") . "đ" }}</strong></span> </div>

                                
                                </div>
                                <div style="padding: 0 15px 15px 100px;">
                                <a href="https://me.momo.vn/anhkevin" target="_blank" class="btn btn-success">
